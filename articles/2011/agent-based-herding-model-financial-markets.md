...
Tags: agent-based models, interactive, stochastic models, 1/f noise, A. Kononovicius, CEV process, voter model, Kirman model, V. Gontis, financial markets, power-law distributions
