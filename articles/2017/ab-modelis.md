...
model]({filename}/articles/2016/rinkejo-modelis.md). In the original
...
state]({filename}/articles/2013/a-kononovicius-i-kazakevicius-valdomu-agentu-itaka-kirmano-modelio-dinamikai.md)."
...
original [Voter model]({filename}/articles/2016/rinkejo-modelis.md).
